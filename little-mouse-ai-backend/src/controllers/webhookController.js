import {handelWebhookEvent} from "../services/webhookService.js"

/**
 * 处理 QQ 机器人开放平台的 Webhook HTTP 请求。
 *
 *  - 从 HTTP 请求中解析 botId / headers / body
 *  - 调用业务层 handleWebhookEvent() 进行：签名验证、op=13验证、事件分发
 ...
 *
 * @example
 * const result = await handleWebhookEvent(botId, req.headers, req.body)
